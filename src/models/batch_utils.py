...
class SeqBatcher(object):
    ...
    def example_parser(self, filename_queue):
        ...
        features = {
            ...
            'x_coords': tf.FixedLenSequenceFeature([], tf.float32),
            'y_coords': tf.FixedLenSequenceFeature([], tf.float32),
            'page_ids': tf.FixedLenSequenceFeature([], tf.float32),
            'line_ids': tf.FixedLenSequenceFeature([], tf.float32),
            'zone_ids': tf.FixedLenSequenceFeature([], tf.float32),

...
'''
' this code is Emma Strubell's implementation of the BiLSTM model
'''
    ...
    def forward(self, input_x1, input_dropout_keep_prob, reuse=True):
        with tf.variable_scope("char-forward", reuse=reuse):
            ...
            with tf.name_scope("char-bilstm"):
                ...
                hidden_outputs_unflat = tf.reshape(hidden_outputs, tf.pack([self.batch_size, self.max_seq_len, self.output_size]))

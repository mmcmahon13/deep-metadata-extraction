...
# Tools to convert a directory of TrueViz docs into serialized TFRecords
# Based on this tutorial: https://indico.io/blog/tensorflow-data-inputs-part1-placeholders-protobufs-queues
# Based (read: copied and modified) on Emma Strubell's tsv_to_tfrecords.py file, credit goes to her)

# TODO: change this to directory and iterate over the csv files?
tf.app.flags.DEFINE_string('in_file', 'naacl-data.tsv', 'tsv file containing string data')
# TODO: do the bio embeddings come with a vocab? do i need to make one from them?
    ...
    for i, line in enumerate(lines):
        if line:
            ...
            if len(parts) < 10:
                ...
                # print(token_str, stupid_label_str)
                ...
                #     label_str = 'O'
                # if 'congress' in token_str.lower(): print(token_str, label_str)
                ...
                chars[char_start:char_start+tok_lens[-1]] = [char_map.get(char, char_map[OOV_STR]) for char in token_str_normalized]
